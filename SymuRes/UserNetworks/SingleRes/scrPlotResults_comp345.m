...
% Result from simulations SC3
%--------------------------------------------------------------------------
% ScenarioList = {'SC31','SC32','SC33'};
% SC31: two trips, demand surge, demprorata-decrdem (model 1/1)
% SC32: two trips, demand surge, demprorata-maxdem (model 1/2)
% SC33: two trips, demand surge, endogenous-maxdem (model 2/2)

% Result from simulations SC4
%--------------------------------------------------------------------------
% ScenarioList = {'SC41','SC42','SC43'};
% SC41: two trips, demand peak, demprorata-decrdem (model 1/1)
% SC42: two trips, demand peak, demprorata-maxdem (model 1/2)
% SC43: two trips, demand peak, endogenous-maxdem (model 2/2)

% Result from simulations SC5
%--------------------------------------------------------------------------
ScenarioList = {'SC51','SC52','SC53'};
% SC51: two trips, supply reduction, demprorata-decrdem (model 1/1)
% SC52: two trips, supply reduction, demprorata-maxdem (model 1/2)
% SC53: two trips, supply reduction, endogenous-maxdem (model 2/2)
...
% ResuList = [1 2]; % list of results: acc-based vs trip-based, model 1/1
% ResuList = [3 4]; % list of results: acc-based vs trip-based, model 1/2
ResuList = [5 6]; % list of results: acc-based vs trip-based, model 2/2
